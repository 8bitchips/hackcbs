                ...
                <div class="collapse navbar-collapse section-links" id="navbarNav">
                    <ul class="navbar-nav">
                        ...
                        @if (config('frontend.features_section') == 'on')
                            <li class="nav-item">
                            		<a class="nav-link scroll" href="https://wecare.teamcode.tech/aiTools.php">{{ __('AI Models') }}</a>
                            </li>
                        @endif
                        @if (config('frontend.pricing_section') == 'on')
                            <li class="nav-item">
                              	<a class="nav-link scroll" href="https://wecare.teamcode.tech/body.html">{{ __('BodyCare') }}</a>
                            </li>
                        @endif
                        @if (config('frontend.faq_section') == 'on')
                         <li class="nav-item">
																<a class="nav-link scroll" href="https://wecare.teamcode.tech/mind.html">{{ __('MindCare') }}</a>
															</li>
                        @endif
                        @if (config('frontend.blogs_section') == 'on')

																<li class="nav-item">
																<a class="nav-link scroll" href="https://wecare.teamcode.tech/login.php">{{ __('Doctor Login') }}</a>
															</li>
                        @endif
                    </ul>
...
@section('content')
                    ...
                    <div class="row h-100vh vertical-center">
                        <div class="col-sm-12 upload-responsive">
                            <div class="text-container text-center">
                                ...
                                <h1 data-aos="fade-up" data-aos-delay="200" data-aos-once="true" data-aos-duration="500">{{ __('Elevate Your Wellbeing with the Magic of AI Generation') }}</span></h1>
                                <div class="word-container" data-aos="fade-up" data-aos-delay="300" data-aos-once="true" data-aos-duration="600">
                                    <h1 class="ah-headline">
                                      <span class="ah-words-wrapper text-center">
                                        <b class="is-visible">{{ __('HealthCare Chatbots') }}</b>
                                        <b>{{ __('AI Models') }}</b>
                                        <b>{{ __('BodyCare') }}</b>
                                        <b>{{ __('MindCare') }}</b>
                                        <b>{{ __('AI Disease Prediction') }}</b>
                                        <b>{{ __('And Many More!') }}</b>
                                      </span>
                                    </h1>
                                  </div>
                                <p class="fs-16" data-aos="fade-up" data-aos-delay="400" data-aos-once="true" data-aos-duration="700">{{ __('Enter a realm where healthcare innovations are realized with a single touch, turning dreams into tangible solutions.') }}</p>
                                ...
                                <a href="{{ route('register') }}" class="btn-primary-frontend btn-frontend-scroll-effect mb-2" id="top-main-button"  data-aos="fade-up" data-aos-delay="500" data-aos-once="true" data-aos-duration="800">
                                    <div>
                                        <span>{{ __('Try Your Health Companion for Free') }}</span>
                                        <span>{{ __('Try Your Health Companion for Free') }}</span>
                                    </div>
                                </a>
                                <div>
                                ...
                                <div class="text-center d-flex mx-auto justify-content-center mt-5" data-aos="fade-up" data-aos-delay="600" data-aos-once="true" data-aos-duration="900">
                                    <div class="happy-customers">
                                        ...
                                        <div>
                                            <span class="fs-12">577 {{ __('Happy Customers') }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <section id="steps-wrapper">
            ...
            <div class="container pt-9 text-center">
                ...
                <div class="row mb-6">
                    <div class="title">
                        <p class="m-2">{{ __('Use Plarform in 3 Easy Steps') }}</p>
                        ...
                        <div class="steps-box-wrapper">
                            <div class="steps-box">
                                ...
                                <div class="step-title">
                                    <h2>{{ __('Select a AI Model tool') }}</h2>
                                </div>
                                <div class="step-description">
                                    <p>{{ __('Choose from a wide array of AI Healtcare Model etc.') }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-12 col-sm-12" data-aos="fade-up" data-aos-delay="200" data-aos-once="true" data-aos-duration="500">
                        <div class="steps-box-wrapper">
                            <div class="steps-box">
                                ...
                                <div class="step-title">
                                    <h2>{{ __('Tell us what to do') }}</h2>
                                </div>
                                <div class="step-description">
                                    <p>{{ __('Explain with as many details as possible to the AI what you would like to know about.') }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container pt-7 text-center">
                    ...
                    <div class="row mb-6">
                        <div class="title">
                            ...
                            <h3>{{ __('The') }}<span> {{ __('Ultimate Power') }} </span>{{ __('of WeCare Generative AI') }}</h3>
                        </div>
                    </div> <!-- END SECTION TITLE -->
                                ...
                                <div class="features-nav-menu-inner">
                                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link active" id="ai-chat-tab" data-bs-toggle="tab" data-bs-target="#ai-chat" type="button" role="tab" aria-controls="ai-chat" aria-selected="true">{{ __('AI HealthCare Chat Bots') }}</button>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link" id="ai-content-tab" data-bs-toggle="tab" data-bs-target="#ai-content" type="button" role="tab" aria-controls="ai-content" aria-selected="false">{{ __('AI HealtCare Contents') }}</button>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link" id="ai-image-tab" data-bs-toggle="tab" data-bs-target="#ai-image" type="button" role="tab" aria-controls="ai-image" aria-selected="false">{{ __('AI HealthCare Images') }}</button>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link" id="ai-voiceover-tab" data-bs-toggle="tab" data-bs-target="#ai-voiceover" type="button" role="tab" aria-controls="ai-voiceover" aria-selected="false">{{ __('AI HealthCare Transcribe') }}</button>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                        ...
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link" id="ai-code-tab" data-bs-toggle="tab" data-bs-target="#ai-code" type="button" role="tab" aria-controls="ai-code" aria-selected="false">{{ __('And Many More') }}</button>
                                        </li>
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-12 pl-6 pr-6 align-middle" data-aos="fade-right" data-aos-delay="200" data-aos-once="true" data-aos-duration="500">
                                                    <div class="features-inner-wrapper text-center">
                                                        ...
                                                        <div class="feature-footer text-center">
                                                            <p class="fs-12">{{ __('Powered By OpenAi and LLM models ') }}</p>
                                                        </div>
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-12 pl-6 pr-6 align-middle">
                                                    <div class="features-inner-wrapper text-center">
                                                        ...
                                                        <div class="feature-title">
                                                            ...
                                                            <h4 class="mb-5 fs-30 number-font">{{ __('Make studio-quality voiceovers in minutes') }}</h4>
                                                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 mb-5" data-aos="zoom-in" data-aos-delay="500" data-aos-once="true" data-aos-duration="500">
                        <div class="benefits-box-wrapper text-center">
                            <div class="benefit-box">
                                <div class="benefit-image">
                                    <img src="{{ URL::asset('https://i.ibb.co/BrqdKcL/123.jpg') }}" alt="">
                                </div>
                                <div class="benefit-title">
                                    <h6>{{ __('Smart BodyCare Tools') }}</h6>
                                </div>
                                <div class="benefit-description">
                                    <p>{{ __('A curated section of helpful tools and information to assist you in your journey of physical well-being.') }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 mb-5" data-aos="zoom-in" data-aos-delay="700" data-aos-once="true" data-aos-duration="500">
                        <div class="benefits-box-wrapper text-center">
                            <div class="benefit-box">
                                <div class="benefit-image">
                                    <img src="{{ URL::asset('https://i.ibb.co/2KKRYJQ/images-2.jpg') }}" alt="">
                                </div>
                                <div class="benefit-title">
                                    <h6>{{ __('Specialized Mind Care') }}</h6>
                                </div>
                                <div class="benefit-description">
                                    <p>{{ __('Use the mind reliever section to get rid out of every stress') }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 mb-5" data-aos="zoom-in" data-aos-delay="800" data-aos-once="true" data-aos-duration="500">
                        <div class="benefits-box-wrapper text-center">
                            <div class="benefit-box">
                                <div class="benefit-image">
                                    <img src="{{ URL::asset('https://i.ibb.co/9qP6L0j/download-2.jpg') }}" alt="">
                                </div>
                                <div class="benefit-title">
                                    <h6>{{ __('Several AI Models') }}</h6>
                                </div>
                                <div class="benefit-description">
                                    <p>{{ __('Explore different AI Models to get convert your confusions to conclusions') }}</p>
                                </div>
                            </div>
                        </div>
                    </div>

        ...
        @role('user|subscriber')
            @if (config('settings.voiceover_feature_user') == 'allow')
                <li class="slide">
                    ...
                    <span class="side-menu__label">{{ __('HealthCare Synthesis') }}</span></a>
                </li>
            @endif
        @endrole
        @role('admin')
        ...
        @role('user|subscriber')
            @if (config('settings.whisper_feature_user') == 'allow')
                <li class="slide">
                    ...
                    <span class="side-menu__label">{{ __('HealthCare Transcribe') }}</span></a>
                </li>
            @endif
        @endrole
        @role('admin')
        ...
        @role('user|subscriber')
            @if (config('settings.image_feature_user') == 'allow')
                <li class="slide">
                    ...
                    <span class="side-menu__label">{{ __('AI HealthCare Images') }}</span></a>
                </li>
            @endif
        @endrole
        @role('admin')
        ...
        @role('user|subscriber')
            @if (config('settings.chat_feature_user') == 'allow')
                <li class="slide mb-3">
                    ...
                    <span class="side-menu__label">{{ __('HealthCare ChatBots') }}</span></a>
                </li>
            @endif
        @endrole
        @role('admin')
        ...
        @role('admin')
            ...
            <li class="slide">
                    <!-- <a class="side-menu__item" data-toggle="slide" href="{{ url('#')}}">
                        ...
                        <span class="side-menu__label">{{ __('Wecare Management') }}</span><i class="angle fa fa-angle-right"></i>
                    </a> -->
                    <ul class="slide-menu">
                        <!-- <li><a href="{{ route('admin.davinci.dashboard') }}" class="slide-item">{{ __('Wecare Dashboard') }}</a></li>
                        <li><a href="{{ route('admin.davinci.templates') }}" class="slide-item">{{ __('Wecare Templates') }}</a></li>
                        ...
                        <!--<li><a href="{{ route('admin.davinci.configs') }}" class="slide-item">{{ __('Wecare Settings') }}</a></li>-->
                    </ul>
            </li>
            <!-- <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('#')}}">
